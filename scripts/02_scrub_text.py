...
from src.utils.file_io import load_dataframe, save_dataframe, save_json, ensure_directory
    ...
    try:
        ...
        if args.validate:
            ...
            if issues:
                ...
                validation_path = output_path.parent / f"{output_path.stem}_validation_issues.json"
